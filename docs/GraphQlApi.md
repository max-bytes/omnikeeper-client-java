...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.debug(graphQLQuery);
    } catch (ApiException e) {
      System.err.println("Exception when calling GraphQlApi#debug");
...
public class Example {
  public static void main(String[] args) {
    ...
    GraphQLQuery graphQLQuery = new GraphQLQuery(); // GraphQLQuery | 
    try {
      apiInstance.index(graphQLQuery);
    } catch (ApiException e) {
      System.err.println("Exception when calling GraphQlApi#index");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
