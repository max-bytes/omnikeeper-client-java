...
public class CytoscapeApi {
    ...
    public CytoscapeApi(ApiClient apiClient) {
    ...
    /**
     * Build call for cytoscapeTraitCentric
     ...
     */
    public okhttp3.Call cytoscapeTraitCentricCall(List<String> layerIDs, String version, List<String> traitIDs, String traitIDsRegex, final ApiCallback _callback) throws ApiException {
     ...
     */
    public void cytoscapeTraitCentric(List<String> layerIDs, String version, List<String> traitIDs, String traitIDsRegex) throws ApiException {
        cytoscapeTraitCentricWithHttpInfo(layerIDs, version, traitIDs, traitIDsRegex);
    }
     ...
     */
    public ApiResponse<Void> cytoscapeTraitCentricWithHttpInfo(List<String> layerIDs, String version, List<String> traitIDs, String traitIDsRegex) throws ApiException {
        okhttp3.Call localVarCall = cytoscapeTraitCentricValidateBeforeCall(layerIDs, version, traitIDs, traitIDsRegex, null);
     ...
     */
    public okhttp3.Call cytoscapeTraitCentricAsync(List<String> layerIDs, String version, List<String> traitIDs, String traitIDsRegex, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = cytoscapeTraitCentricValidateBeforeCall(layerIDs, version, traitIDs, traitIDsRegex, _callback);
