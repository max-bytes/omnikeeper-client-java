...
public class EditContextRequest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to EditContextRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EditContextRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EditContextRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EditContextRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("configuration") != null && !jsonObj.get("configuration").isJsonNull()) {
        GridViewConfiguration.validateJsonElement(jsonObj.get("configuration"));
      }
  }
