...
public class AddContextRequest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to AddContextRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddContextRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddContextRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddContextRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
