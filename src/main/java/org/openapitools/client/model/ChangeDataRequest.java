...
public class ChangeDataRequest {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ChangeDataRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ChangeDataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
