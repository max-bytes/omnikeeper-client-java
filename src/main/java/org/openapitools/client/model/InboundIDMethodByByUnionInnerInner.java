...
public class InboundIDMethodByByUnionInnerInner extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(InboundIDMethodByByUnionInnerInner.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!InboundIDMethodByByUnionInnerInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'InboundIDMethodByByUnionInnerInner' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<InboundIDMethodByByUnionInnerInner>() {
                @Override
                public void write(JsonWriter out, InboundIDMethodByByUnionInnerInner value) throws IOException {
                ...
                @Override
                public InboundIDMethodByByUnionInnerInner read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        InboundIDMethodByByUnionInnerInner ret = new InboundIDMethodByByUnionInnerInner();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for InboundIDMethodByByUnionInnerInner: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public InboundIDMethodByByUnionInnerInner() {
        super("oneOf", Boolean.FALSE);
    }

    public InboundIDMethodByByUnionInnerInner(InboundIDMethodByAttribute o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public InboundIDMethodByByUnionInnerInner(InboundIDMethodByAttributeModifiers o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public InboundIDMethodByByUnionInnerInner(InboundIDMethodByByUnion o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public InboundIDMethodByByUnionInnerInner(InboundIDMethodByData o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public InboundIDMethodByByUnionInnerInner(InboundIDMethodByIntersect o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public InboundIDMethodByByUnionInnerInner(InboundIDMethodByRelatedTempID o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public InboundIDMethodByByUnionInnerInner(InboundIDMethodByTemporaryCIID o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return InboundIDMethodByByUnionInnerInner.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InboundIDMethodByByUnionInnerInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for InboundIDMethodByByUnionInnerInner with oneOf schemas: InboundIDMethodByAttribute, InboundIDMethodByAttributeModifiers, InboundIDMethodByByUnion, InboundIDMethodByData, InboundIDMethodByIntersect, InboundIDMethodByRelatedTempID, InboundIDMethodByTemporaryCIID. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of InboundIDMethodByByUnionInnerInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InboundIDMethodByByUnionInnerInner
  * @throws IOException if the JSON string is invalid with respect to InboundIDMethodByByUnionInnerInner
  */
  public static InboundIDMethodByByUnionInnerInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InboundIDMethodByByUnionInnerInner.class);
  }

 /**
  * Convert an instance of InboundIDMethodByByUnionInnerInner to an JSON string
  *
  * @return JSON string
  */
